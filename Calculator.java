...
public class Calculator
{
    ...
    public String BMIcalulator(String age, String gender, String height, String weight)
    {
        ...
        String actual_result = driver.findElement(By.xpath("//div[@class='bigtext']")).getText().trim();
    ...
    public void test1()
    {
        ...
        Assert.assertEquals(BMIcalulator("20", "Male", "180", "60"), "BMI=18.5 kg/m");
    }
    @Test
    public void test2() {
        BMIcalulator("35", "Female", "160", "55");
        Assert.assertEquals(BMIcalulator("35", "Female", "160", "55"), "BMI=21.5 kg/m");
    }
    @Test
    public void test3() {
        BMIcalulator("50", "Male", "175", "65");
        Assert.assertEquals(BMIcalulator("50", "Male", "175", "65"), "BMI=21.2 kg/m");

    }
    @Test
    public void test4() {
        BMIcalulator("45", "Female", "150", "52");
        Assert.assertEquals(BMIcalulator("45", "Female", "150", "52"), "BMI=23.1kg/m");
